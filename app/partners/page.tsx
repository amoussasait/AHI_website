...
export default function PartnersPage() {
  const partnerCategories = [
    ...
    },
    {
      ...
      partners: [
        ...
        },
        {
          ...
          logo: "/images/chandos-logo.png",
          role: "General Contractor",
          description: "National construction leader delivering complex industrial and mission-critical infrastructure across Canada.",
          website: "#",
        },
        {
          name: "Volker Stevin",
          logo: "/images/volker-stevin-logo.png",
          role: "Civil Contractor",
          description: "Heavy civil and infrastructure contractor specializing in large-scale site works, utilities, and transportation systems.",
          website: "#",
        },
        {
          name: "ISL Engineering",
          logo: "/images/isl-logo.png",
          role: "Civil Engineering Partner",
          description: "Full-service engineering firm providing municipal, civil, and infrastructure design for large industrial campuses.",
          website: "#",
        },
      ],
    },
    ...
    {
      category: "Governance, Finance & Affiliates",
      partners: [
        {
          name: "Havenz Smart Communities",
          logo: "/images/havenz-smart-communities-logo.png",
          role: "Visionary & Lead Developer",
          description: "Project sponsor and master developer responsible for strategic vision, capital structuring, land development, and integrated infrastructure delivery.",
          website: "#",
        },
        {
        ...
        },
        {
          ...
          logo: "/images/red-deer-county-logo.png",
          role: "Municipal Authority",
          description: "Pro-development municipal partner supporting industrial growth, permitting, and infrastructure alignment.",
          website: "https://www.reddeer.ca",
        },
        {
          name: "Invest Alberta",
          logo: "/images/invest-alberta-logo.png",
          role: "Data Centre Concierge Services",
          description: "Provincial investment facilitation agency supporting strategic infrastructure projects and international capital deployment.",
          website: "#",
        },
        {
          name: "Western Canada Data Centre Alliance",
          logo: "/images/wcdda-logo.png",
          role: "Industry Association Partner",
          description: "Regional industry alliance supporting data centre development, best practices, and policy advocacy.",
          website: "#",
        },
      ],
    },
  ...
  return (
    <PageLayout
      title="United by Vision, Empowered by Collaboration"
      subtitle="A world-class coalition of partners driving Canada's sovereign AI infrastructure forward"
    >
      {/* Partner Categories */}
